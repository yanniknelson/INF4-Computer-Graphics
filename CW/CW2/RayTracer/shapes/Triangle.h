...
public:
	...
	Triangle(Vec3f v0, Vec3f v1, Vec3f v2, Vec3f n0, Vec3f n1, Vec3f n2, Material* mat = nullptr) : n0(n0), n1(n1), n2(n2), v0(v0), v1(v1), v2(v2) {
		material = mat;
		hasNormals = true;
		Vec3f avg = ((v0 + v1 + v2) / 3).normalized();
		centroid = (v0 + v1 + v2) / 3;
	...
	Triangle(Vec3f v0, Vec3f v1, Vec3f v2, Vec3f n0, Vec3f n1, Vec3f n2, Vec2f t0, Vec2f t1, Vec2f t2, Material* mat = nullptr) : n0(n0), n1(n1), n2(n2), t0(t0), t1(t1), t2(t2), v0(v0), v1(v1), v2(v2) {
		material = mat;
		hasNormals = true;
		hasTextureMaps = true;
		Vec3f avg = ((v0 + v1 + v2) / 3).normalized();
